...
def format_single_paper_extraction_prompt(extraction_input: dict) -> str:
    ...
    return (
        ...
        "- Exactly one finding, but make it substantive: 2-3 concise Arabic sentences, "
        "approximately 80-100 Arabic words. Include the specific result, and where the abstract "
        "states it, relevant context such as sample/population, method, or comparison group.\n"
...
def format_final_synthesis_prompt(final_synthesis_input: dict) -> str:
    ...
    return (
        ...
        "OUTPUT LIMITS (prioritize facts and stated uncertainty over eloquence, but be substantive, not terse):\n"
        "- where_studies_disagree: at most 2 items. Each issue is 1-2 concise Arabic sentences. "
        "Leave this list empty if the findings do not genuinely disagree.\n"
        "- what_cannot_be_concluded: at most 3 items. Each item is 1-2 concise Arabic sentences.\n"
        "- ai_synthesis: approximately 200-220 Arabic words.\n"
